        ...
        <div className="col-start-4 col-end-12">
          <div className="flex flex-col">
            <div className="bg-white text-xl py-4 px-6 font-medium rounded-lg">
              ...
              and processing payments for clients. In addition, they communicate
              with patients about outstanding balancescollecting on behalf of
              their employer or provider institution as necessary to ensure the
              patient’s procedures are paid for by their insurance company
            </div>
            <div>
              <Carousel />
            </div>
